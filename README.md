...
<p align="center">
  ...
  <strong>비를 덜 맞으려면 몇 시에 나가야 하는지</strong>까지 계산해주는 일정 맞춤 날씨 브리핑
</p>
...
가장 큰 차별점은 **비 피해서 나가기**입니다. 사용자가 희망 출발 시각, 조정 가능한 범위, 외출 시간을 입력하면 기상청 시간별 예보를 비교해 더 안전한 출발 시각과 일정 변경 효과를 점수로 보여줍니다.

단순한 “오늘 27°C” 대신 다음 질문에 답하는 서비스입니다.

- 우산이나 마스크를 챙겨야 할까?
- 18시 대신 19시에 나가면 비를 얼마나 덜 맞을까?
...
| 일정 최적화 | 희망 시각 전후를 시간별로 비교해 최적 출발, 부담 감소 점수, 준비물 제안 |
...
고정된 아침·점심·저녁 예보가 아니라 사용자의 실제 일정 전후를 비교합니다.

- 오늘부터 모레까지 희망 출발 시각 지정
- 전후 1시간~3시간, 외출 30분~2시간 범위 분석
- 후보별 강수확률, 강수 형태, 기온, 풍속과 외출 점수 비교
- 원래 시각 대비 날씨 부담 감소 점수와 추천 이유 제공
- 추천 일정의 `.ics` 캘린더 저장
- 기상청 발표·수집시각, 자료 완전성, 장애 시 대체자료 여부 표시
